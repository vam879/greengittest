...
<body>
    ...
    <div class="container">
        <aside class="sidebar">
            ...
            <ul>
                ...
                <a href="./대학생활3-식단안내.html"><li class="highlight">식단안내</li></a>
                <a href="./대학생활4-갤러리.html"><li>갤러리</li></a>
            </ul>
        </aside>
        <main class="content">
            <h2>식단안내</h2>
        ...
        <div class="date-navigation">
            ...
            <img src="./images/btn-calendar-prev.gif" alt="그린대학교 로고"><p>2025.03.10 ~ 2025.03.14</p><img src="./images/btn-calendar-next.gif" alt="그린대학교 로고">
            <!-- <span class="arrow">&gt;</span> -->
        </div>        
        <thead>
            <tr style="background:#084a87; color: #ffffff">
                <th>구분</th>
                <th>2025.3.10(월)</th>
                <th>2025.3.11(화)</th>
                <th>2025.3.12(수)</th>
        ...
        <tbody class="tr-body">
            ...
            <tr class="tr2">
                <td>중식</td>
                <td><br><span style="color:green; font-weight:bold;">정식 5,500원</span><br>백미밥<br>바지락미역국<br>닭안심매콤조림<br>야끼우동<br>두부강정<br>상추겉절이<br>포기김치</td>
                <td><span style="color:green; font-weight:bold;">정식 5,500원</span><br>백미밥<br>바지락미역국<br>닭안심매콤조림<br>야끼우동<br>두부강정<br>상추겉절이<br>포기김치</td>
                <td><span style="color:green; font-weight:bold;">정식 5,500원</span><br>백미밥<br>바지락미역국<br>닭안심매콤조림<br>야끼우동<br>두부강정<br>상추겉절이<br>포기김치</td>
                <td><span style="color:green; font-weight:bold;">정식 5,500원</span><br>백미밥<br>바지락미역국<br>닭안심매콤조림<br>야끼우동<br>두부강정<br>상추겉절이<br>포기김치</td>
                <td><span style="color:green; font-weight:bold;">정식 5,500원</span><br>백미밥<br>바지락미역국<br>닭안심매콤조림<br>야끼우동<br>두부강정<br>상추겉절이<br>포기김치</td>
    ...
    <p style="margin-top:10px; font-size:14px; color:#555;">※ 항상 그린식당을 이용해 주셔서 감사합니다.</p>
        </main>
    </div>
