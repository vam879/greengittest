    ...
    <div class="container">
        <aside class="sidebar">
            ...
            <ul>
                ...
                <a href="./커뮤니티6-자료실.html"><li class="highlight">자료실</li></a>
            </ul>
        </aside>
        <div class="content">
				<div class="content">
                ...
                <div class="job-info-section"> <div class="search-box">
                    ...
                    <table class="notice-table">
                        ...
                        <tbody>
                            <tr>
                                <td>3</td>
                                <td><span class="lcok"><img src="./images/ico-file01.png" alt="new"></span> 교원자격증 재교부 및 기재사항 정정신청 안내(서식)</td>
                                <td>학사관리과</td>
                                <td>24.04.09</td>
                                <td>120</td>
                            </tr>
                            <tr>
                                <td>3</td>
                                <td><span class="lcok"><img src="./images/ico-file01.png" alt="new"></span>2025 융합인재학부 오리엔테이션 자료</td>
                                <td>융합인재학부</td>
                                <td>24.04.09</td>
                                <td>120</td>
                            </tr>
                            <tr>
                                <td>3</td>
                                <td><span class="lcok"><img src="./images/ico-file01.png" alt="new"></span>2022년 2월 8일 면접 전략 특강 강의 자료</td>
                                <td>취업지원실</td>
                                <td>24.04.09</td>
                                <td>120</td>
                            </tr>
