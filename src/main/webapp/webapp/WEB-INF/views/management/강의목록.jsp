            ...
            <section class="section" aria-label="content">
                ...
                <div class="section-container">
                    ...
                    <div class="mainWrap">
                        <div class="page">
                        <div class="page-head">
                            <div class="title">강의목록</div>
                            <div class="breadcrumb"><a href="#">학사운영</a> &gt; 
                            <span class="current">강의목록</span>
                            </div>
                        </div>
                   ...
                   <section class="panel">                            
                            ...
                            <table class="table">
                                <thead>
                                <tr>
                                    <th>과목코드</th><th>학과</th><th>학년</th><th>구분</th><th>과목명</th><th>교수</th>
                                    <th>학점</th><th>수업시간</th><th>강의실</th><th>최대 수강 인원</th>
                                </tr>
                                </thead>
                                <tbody>
                                <tr>
                                    <td>3025112</td><td>컴퓨터공학과</td><td>1</td><td>전공선택</td><td>프로그래밍 개론</td>
                                    <td>김컴공</td><td>3</td><td>월,수 10:10~12:00</td><td>컴퓨터실</td><td>30</td>
                                </tr>
                                 <tr>
                                    <td>3025112</td><td>컴퓨터공학과</td><td>1</td><td>전공선택</td><td>프로그래밍 개론</td>
                                    <td>김컴공</td><td>3</td><td>월,수 10:10~12:00</td><td>컴퓨터실</td><td>30</td>
