...
<head>
    ...
    <link rel="stylesheet" href="./입학안내_공통.css">
    <style>
                        ...
                        <table>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>정시</td>
                                    <td class="left-list">
                                    <img src="./images/ico-lock.png" style="width:16px; height:16px; vertical-align:middle; margin-right:6px;">
                                    정시모집 관련해 문의드립니다</td>
                                    <td>홍길동</td>
                                    <td>24.04.09</td>
                                    <td class="status answered-no">답변완료</td>
                                </tr>
                                <tr>
                                    <td>3</td>
                                    <td>정시</td>
