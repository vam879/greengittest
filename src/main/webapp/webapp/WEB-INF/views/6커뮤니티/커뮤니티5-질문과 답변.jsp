...
<head>
    ...
    <link rel="stylesheet" href="./커뮤니티_공통.css">
    ...
    <div class="container">
        <aside class="sidebar">
            ...
            <ul>
                ...
                <a href="./커뮤니티5-질문과 답변.html"><li class="highlight">질문과 답변</li></a>
                <a href="./커뮤니티6-자료실.html"><li>자료실</li></a>
            </ul>>
        </aside>
        <div class="content">
				<div class="content">
                <h2>질문과 답변</h2> <hr style="border: none; border-top: 3px solid #000; margin: 5px 0 20px 0;">
                    ...
                    <table class="notice-table">
                        <thead>
                         ...
                         <tbody>
                                    <tr>
                                        <td>5</td>
                                        <td><span class="lock"><img src="./images/ico-lock.png" alt="new"></span> 문의드립니다.</td>
                                        <td>홍길동</td>
                                        <td>24.04.09</td>
                                    ...
                                    <tr style="background-color: #efefef">
                                        <td>3</td>
                                        <td><span class="lcok"><img src="./images/ico-reply.png" alt="new"></span> RE:[답변]취업진로상담</td>
                                        <td>담당자</td>
                                        <td>24.04.09</td>
                                        <td style="color: green;">답변완료</td>
                                    </tr>
                                    <tr>
                                        <td>2</td>
                                        <td><span class="lcok"><img src="./images/ico-lock.png" alt="new"></span> 취업실전전략1 일반선택 교과목 문의입니다</td>
                                        <td>학사지원실</td>
                                        <td>24.04.09</td>
                                        <td style="color: green;">답변완료</td>
                                    </tr>
                                    <tr style="background-color: #efefef">
                                        <td>1</td>
                                        <td><span class="lcok"><img src="./images/ico-reply.png" alt="new"></span> RE:[답변]취업실전전략1 일반선택 교과목 문의입니다</td>
                                        <td>학사지원실</td>
                                        <td>24.04.09</td>
                                        <td style="color: green;">답변완료</td>
                                    </tr>
